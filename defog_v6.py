# defog_v6_simple.py (基於 proposed_v5，加入動態 PSI 調整)
import numpy as np
...
=================================================================
V6 新增: 動態 PSI
- 使用 sliding window (size=8) 計算局部霧濃度
- 霧濃度 = |pixel - A| / A
- 霧濃 → PSI 高, 無霧 → PSI 低
- PSI 切分成 100 等份 (0.5 ~ 1.2)
"""
