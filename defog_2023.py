...
======================================================================
defog_2023 Summary vs Targets
======================================================================
Dataset         |     PSNR (     Tgt) |     SSIM (     Tgt) |    CIEDE (     Tgt)
----------------+---------------------+---------------------+--------------------
SOTS_in         | 19.0330+ (18.8006) |  0.7959+ ( 0.7856) |  8.2608+ (10.4843)
SOTS_out        | 18.5615- (22.1355) |  0.8310- ( 0.8840) |  9.2497- ( 6.0956)
Ohaze           | 15.3796- (16.7290) |  0.5570- ( 0.5942) | 18.4829- (15.3479)
Ihaze           | 14.1270+ ( 0.0000) |  0.7047+ ( 0.0000) | 16.8274+ (99.0000)
======================================================================
"""
